package com.krit.jblock.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.krit.jblock.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.krit.jblock.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
